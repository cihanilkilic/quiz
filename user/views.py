...
#     return render(request, 'user/login.html', {'form': form, 'title': 'Giriş Yap'})
    ...
    if user is not None and default_token_generator.check_token(user, token):
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return HttpResponse("Parola başarıyla değiştirildi.")
        else:
...
def User_Profil(request, pk):
    ...
    # POST işlemi için kullanıcı profilini güncelleme
        ...
        # POST isteğiyle gönderilen verileri almak için request.POST kullanabilirsiniz.
        # Örnek olarak, kullanıcının profil bilgilerini güncellemek için form verilerini burada işleyebilirsiniz.
        # Güncellenen verileri veritabanına kaydedebilir ve kullanıcıyı başka bir sayfaya yönlendirebilirsiniz.
        # Örnek olarak:
...
#     if request.method == 'POST':
#         try:
#             # Retrieve updated profile information from the POST request
...
#             social_media_tiktok = request.POST.get('social_media_tiktok')
#             mobile_phone = request.POST.get('mobile_phone')
#             mail_adress = request.POST.get('mail')
#             biographys = request.POST.get('biography')

#             # Update profile fields
#             if avatars:
#                 profile.avatars = avatars
#             if social_media_facebook:
#                 profile.social_media_facebook = social_media_facebook
#             if social_media_twitter:
#                 profile.social_media_twitter = social_media_twitter
#             if social_media_instagram:
#                 profile.social_media_instagram = social_media_instagram
#             if social_media_tiktok:
#                 profile.social_media_tiktok = social_media_tiktok
#             if mobile_phone:
#                 profile.mobile_phone = mobile_phone
#             if mail_adress:
#                 profile.mail_adress = mail_adress
#             if biographys:
#                 profile.biographys = biographys

#             # Save the updated profile
#             profile.save()
#             return redirect('quizorder:index')  # Redirect to a success URL

#         except Exception as e:
#             # Handle any errors that occur during the update process
#             return render(request, 'error.html', {'error_message': str(e)})

#     # If request method is not POST, render the update profile form
#     return render(request, 'update_profile.html', {'profile': profile})
#     #return render(request, 'user/profil.html.html', {'profile': profile})
